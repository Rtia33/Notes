...
# 【Android 视图 仿饿了么图片变详情】
转自：
[这交互炸了：饿了么是怎么让Image变成详情页的](https://blog.csdn.net/wingichoy/article/details/53501179)

效果图：
[![仿饿了么图片变详情.gif](https://upload-images.jianshu.io/upload_images/9028834-0919f84aabb50fe3.gif?imageMogr2/auto-orient/strip)](https://upload-images.jianshu.io/upload_images/9028834-0919f84aabb50fe3.gif?imageMogr2/auto-orient/strip)
接下来将和大家分享这个效果是如何实现的。讲思路以及遇到的问题。但是不会讨论细节，具体的细节请看源码。
...
如果你觉得还不错，欢迎Star 
[本项目地址](https://github.com/githubwing/ZoomHeader)
